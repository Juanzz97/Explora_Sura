# -*- coding: utf-8 -*-
"""Copia de 7. Despliegue-Car Risk.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1d-_gfcT_XQnHI_LOxb3t6XTBFD8mp0aC
...
#Cargamos los datos futuros
#data = pd.read_csv("/content/Datos_futuros_20.csv")
#data.head()
...
Nivel_Estudios = ('Nivel_Estudios', ["'SIN NIVEL EDUCATIVO'","'TECNICA'","'SECUNDARIA'","'PRIMARIA'","'PROFESIONAL'","'ESPECIALIZACION'","'TECNOLOGICA'","'MAESTRIA'","'OTRO'","'DOCTORADO/POSDOCTORADO'"])
